...
namespace WPF_PIM_4.Visualizar
{
    public partial class AdminControle : UserControl
    {
        ...
        {
            if (dataGridEmails.SelectedItem is RegistroUnificado registro && !string.IsNullOrEmpty(registro.Email))
            {
        ...
        {
            if (dataGridSugestoes.SelectedItem is RegistroUnificado registro && !string.IsNullOrEmpty(registro.Sugestao))
            {
        ...
        {
            if (dataGridRespostas.SelectedItem is RegistroUnificado registro && !string.IsNullOrEmpty(registro.Resposta))
            {
